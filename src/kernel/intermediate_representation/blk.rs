...
impl Term<Blk> {
    ...
    /// and allows more dead stores to be removed during [dead variable elimination](`crate::kernel::analysis::dead_variable_elimination`).
...
mod tests {
    use super::*;
    use crate::kernel::intermediate_representation::{Def, Expression, Variable};
