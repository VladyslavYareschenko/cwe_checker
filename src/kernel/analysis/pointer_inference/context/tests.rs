...
fn context_problem_implementation() {
    use crate::kernel::analysis::forward_interprocedural_fixpoint::Context as IpFpContext;
    use crate::kernel::analysis::pointer_inference::Data;
    use Expression::*;
    ...
    let target_node = crate::kernel::analysis::graph::Node::BlkStart(&target_block, &sub);
...
fn update_return() {
    use crate::kernel::analysis::forward_interprocedural_fixpoint::Context as IpFpContext;
    use crate::kernel::analysis::pointer_inference::object::ObjectType;
    use crate::kernel::analysis::pointer_inference::Data;
    let (project, config) = mock_project();
    let graph = crate::kernel::analysis::graph::get_program_cfg(&project.program, HashSet::new());
    let runtime_memory_image = RuntimeMemoryImage::mock();
