...
use crate::kernel::{abstract_domain::*, utils::binary::RuntimeMemoryImage};
    ...
    fn abstract_object_list() {
        ...
        assert_eq!(
            other_obj_list
                ...
                .0
                .get_state(),
            crate::kernel::analysis::pointer_inference::object::ObjectState::Alive
        );
        other_obj_list
        ...
        assert_eq!(
            other_obj_list
                ...
                .0
                .get_state(),
            crate::kernel::analysis::pointer_inference::object::ObjectState::Dangling
        );
    }
