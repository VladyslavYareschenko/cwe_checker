...
impl<'a> Context<'a> {
    pub fn new(project: &'a Project) -> Self {
        let mut graph = crate::kernel::analysis::graph::get_program_cfg(&project.program, HashSet::new());
        graph.reverse();
...
impl<'a> crate::kernel::analysis::backward_interprocedural_fixpoint::Context<'a> for Context<'a> {
    type Value = u64;
