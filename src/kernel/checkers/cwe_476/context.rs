...
use crate::kernel::analysis::graph::{Graph, Node};
...
use crate::kernel::analysis::pointer_inference::State as PointerInferenceState;
use crate::kernel::intermediate_representation::*;
...
impl<'a> crate::kernel::analysis::forward_interprocedural_fixpoint::Context<'a> for Context<'a> {
    type Value = State;
