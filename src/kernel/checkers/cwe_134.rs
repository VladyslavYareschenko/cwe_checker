...
use crate::kernel::analysis::graph::Edge;
use crate::kernel::analysis::interprocedural_fixpoint_generic::NodeValue;
use crate::kernel::analysis::pointer_inference::PointerInference;
use crate::kernel::intermediate_representation::ExternSymbol;
use crate::kernel::intermediate_representation::Jmp;
use crate::kernel::intermediate_representation::Variable;
use crate::kernel::prelude::*;
use crate::kernel::utils::binary::RuntimeMemoryImage;
use crate::kernel::utils::log::CweWarning;
use crate::kernel::utils::log::LogMessage;
use crate::kernel::CweModule;
...
pub fn check_cwe(
    ...
    let format_string_symbols =
        crate::kernel::utils::symbol_utils::get_symbol_map(project, &config.format_string_symbols[..]);
...
pub mod tests {
    ...
    use crate::kernel::analysis::pointer_inference::PointerInference as PointerInferenceComputation;
    use crate::kernel::intermediate_representation::{Blk, Def, Expression, Jmp, Project, Sub};
    ...
    fn test_locate_format_string() {
        ...
        let graph = crate::kernel::analysis::graph::get_program_cfg(&project.program, HashSet::new());
        let mut pi_results =
