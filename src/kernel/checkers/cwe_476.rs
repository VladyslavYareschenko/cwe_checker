...
//! that the [Pointer Inference analysis](crate::kernel::analysis::pointer_inference) could not track,
...
use crate::kernel::analysis::forward_interprocedural_fixpoint::create_computation;
use crate::kernel::analysis::forward_interprocedural_fixpoint::Context as _;
use crate::kernel::analysis::graph::{Edge, Node};
...
pub fn check_cwe(
    ...
    let symbol_map = crate::kernel::utils::symbol_utils::get_symbol_map(project, &config.symbols[..]);
