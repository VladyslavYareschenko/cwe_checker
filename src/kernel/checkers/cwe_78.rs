...
pub fn check_cwe(
    ...
    let system_symbols =
        crate::kernel::utils::symbol_utils::get_symbol_map(project, &config.system_symbols[..]);
...
impl<'a> SymbolMaps<'a> {
    ...
    pub fn new(project: &'a Project, config: &Config) -> Self {
        ...
        SymbolMaps {
            string_symbol_map: crate::kernel::utils::symbol_utils::get_symbol_map(
                project,
                &config.string_symbols[..],
            ),
            user_input_symbol_map: crate::kernel::utils::symbol_utils::get_symbol_map(
                project,
...
/// - block_first_def_set:
///       - A set containing a given [`Def`](crate::kernel::intermediate_representation::Def) as the first `Def` of the block.
...
///       containing a given [`Def`](crate::kernel::intermediate_representation::Def) as the last `Def` of the block.
///       The keys are of the form `(Def-TID, Current-Sub-TID)`
///       to distinguish the nodes for blocks contained in more than one function.
