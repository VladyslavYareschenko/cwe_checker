...
use crate::kernel::abstract_domain::IntervalDomain;
use crate::kernel::analysis::pointer_inference::{Data, PointerInference as PointerInferenceComputation};
...
use crate::kernel::{checkers::cwe_476::Taint, utils::log::CweWarning};
...
fn tainting_generic_extern_symbol_parameters() {
    ...
    let graph = crate::kernel::analysis::graph::get_program_cfg(&setup.project.program, HashSet::new());
