...
impl RegisterDomain for IntervalDomain {
    ...
    fn bin_op(&self, op: BinOpType, rhs: &Self) -> Self {
        use crate::kernel::intermediate_representation::BinOpType::*;
        match op {
    ...
    fn un_op(&self, op: crate::kernel::intermediate_representation::UnOpType) -> Self {
        use crate::kernel::intermediate_representation::UnOpType::*;
        match op {
            Int2Comp => {
    ...
    fn cast(&self, kind:
            crate::kernel::intermediate_representation::CastOpType, width:
            crate::kernel::intermediate_representation::ByteSize) -> Self {
        use crate::kernel::intermediate_representation::CastOpType::*;
        match kind {
            IntZExt => {
                assert!(self.bytesize() <= width);
