use super::*;
use crate::kernel::intermediate_representation::{UnOpType, CastOpType};
...
impl<T: RegisterDomain> RegisterDomain for DataDomain<T> {
    ...
    fn bin_op(&self, op: crate::kernel::intermediate_representation::BinOpType, rhs: &Self) -> Self {
...
mod tests {
    ...
    use crate::kernel::intermediate_representation::{Tid, Bitvector};
