...
pub struct AbstractIdentifierData {
    time: crate::kernel::prelude::Tid,
    location: AbstractLocation,
}

impl AbstractIdentifier {
    /// create a new abstract identifier
    pub fn new(time: crate::kernel::prelude::Tid, location: AbstractLocation) -> AbstractIdentifier {
...
pub enum AbstractLocation {
    ...
    Register(String, crate::kernel::prelude::ByteSize),
...
impl AbstractLocation {
    ...
    pub fn from_var(variable: &crate::kernel::intermediate_representation::Variable)
    -> Result<AbstractLocation, crate::kernel::prelude::Error> {
        if variable.is_temp {
