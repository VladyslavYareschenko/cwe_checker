...
see the [configuration struct documentation](crate::kernel::binary::BareMetalConfig).
...
use crate::kernel::analysis::graph::Graph;
use crate::kernel::analysis::pointer_inference::PointerInference;
use crate::kernel::intermediate_representation::Project;
use crate::kernel::utils::binary::RuntimeMemoryImage;
use crate::kernel::utils::log::{CweWarning, LogMessage};
...
mod prelude {
    ...
    pub use crate::kernel::intermediate_representation::{Bitvector, BitvectorExtended, ByteSize};
    pub use crate::kernel::intermediate_representation::{Term, Tid};
    pub use crate::kernel::AnalysisResults;
...
pub fn get_modules() -> Vec<&'static CweModule> {
    vec![
        &crate::kernel::checkers::cwe_215::CWE_MODULE,
        &crate::kernel::checkers::cwe_243::CWE_MODULE,
        &crate::kernel::checkers::cwe_332::CWE_MODULE,
        &crate::kernel::checkers::cwe_367::CWE_MODULE,
        &crate::kernel::checkers::cwe_426::CWE_MODULE,
        &crate::kernel::checkers::cwe_467::CWE_MODULE,
        &crate::kernel::checkers::cwe_476::CWE_MODULE,
        &crate::kernel::checkers::cwe_560::CWE_MODULE,
        &crate::kernel::checkers::cwe_676::CWE_MODULE,
        &crate::kernel::checkers::cwe_782::CWE_MODULE,
        &crate::kernel::analysis::pointer_inference::CWE_MODULE,
    ]
}
...
impl<'a> AnalysisResults<'a> {
    ...
    pub fn compute_pointer_inference(
        ...
        crate::kernel::analysis::pointer_inference::run(
            self.project,
